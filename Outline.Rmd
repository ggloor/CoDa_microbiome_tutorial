...
### 9-9:45 - Introduction (Gloor, didactic lecture)
...
### 10-10:45 - Probabilities and ratio transformations (Gloor, hands on)
...
### 11-11:45 - Dimension reduction, outlier identification and clustering (Gloor, hands on)
...
### 1-1:20 - Correlation and compositional association (Erb)
...
2:30-3:15 - Differential abundance with ALDEx2 (Gloor)
...
### 3:30-4:15 - Working with users' data (Gloor, Erb)
